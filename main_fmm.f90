...
! --------------------------   end modify   --------------------------  
!
! now, call the ddpcm_fmm solver
!
do_adjoint = igrad.eq.1
call ddpcm_init()
nadm = 1000
call cpu_time(start_time)
call ddpcm_fmm(do_adjoint, phi, psi, esolv, 2*lmax, 2*lmax, nadm)
call cpu_time(finish_time)
write(*, "(A,ES23.15E3)") " ddpcm_fmm esolv: ", esolv
write(*, "(A,ES11.4E2,A)") " ddpcm_fmm time: ", finish_time-start_time, &
    & " seconds"
